...
! MODULE HDF5_IO
!
! This module contains the subroutines for writing HDF5 files.
!
...
! **********************************************************************************************************************
    ...
    WRITE(*,*) SHAPE(dot1), SHAPE(dot2), SHAPE(z0)
    WRITE(*,*) nmol, nconfig
    ...
    DO i=1, nmol
        ...
        ! Write first OH
        !   Dot product of the first OH bond vector with the projected field.
        ...
        !   The Z position of the first OH
        CALL h5screate_simple_f(1, dot_dims, dataspace_id, ERROR_FLAG)
        ...
        !   The bond vector of the first OH
        ...
        ! Write Second OH 
        !   Dot product of the second OH bond vector with the projected field.
        CALL h5screate_simple_f(1, dot_dims, dataspace_id, ERROR_FLAG)
        ...
        !   The Z position of the second OH
        CALL h5screate_simple_f(1, dot_dims, dataspace_id, ERROR_FLAG)
        ...
        !   The bond vector of the second OH
        CALL h5screate_simple_f(2, eoh_dims, dataspace_id, ERROR_FLAG)
